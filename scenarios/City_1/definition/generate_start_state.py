...
class StateGenerator:
    ...
    # cityMVA_ETrims_Jan2018_April2019.json
    ...
    def get_regions(self,
        ...
        # TODO | this is specific to <>'s's implementation - he set invalid cells to <num_regions>, i.e. one more than last valid region
...
if __name__ == "__main__":
    ...
    data_directory = '../../../../data/'
    incident_df_path = ''
    depot_info_path = data_directory +  ''
    region_cluster_file = data_directory + ''
    num_regions = 5
    structural_valid_cells = pickle.load(open(data_directory + '', 'rb'))
    ...
    within_region_travel_model = WithinRegionTravelModel(mean_dist_for_region_dict=region_mean_distance_dict,
