...
def get_resp_init_assignments_to_regions_and_depots(hl_policy,
    ...
    for r in region_ids:
        ...
        print('\t{} - rate {}'.format(r, region_incident_rates[r]))
...
if __name__ == "__main__":
    ...
    indexes_of_sample_chains = list(range(1))
    ...
    while curr_time < end_time:
        ...
        get_resp_init_assignments_to_regions_and_depots(hl_policy=hl_policy,
                                                                       region_ids=region_ids,
                                                                       curr_time=curr_time,
