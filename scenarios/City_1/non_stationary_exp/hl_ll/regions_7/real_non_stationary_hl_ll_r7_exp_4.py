...
if __name__ == "__main__":
    ...
    ############################################
    ### run specific
    pool_thread_count = 8  # aw machine??
    ...
    ########################################
    ### run specific
    file_name_for_experiement = 'real_non_stationary_result-' + config_info['exp_id'] + '.pkl'

    decision_coordinator = HighAndLowLevelCoord(environment_model=env_model,
